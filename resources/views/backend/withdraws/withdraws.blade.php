                    ...
                    <table class="example1 table table-bordered table-striped">
                        ...
                        <tbody>
                            ...
                            <tr>
                                ...
                                <td>
                                    @if($setting['status'] == 0)
                                        <button class="btn btn-success btn-sm" onclick="acceptSettings(this,'{{$setting['id']}}', true)"><i class="fas fa-check"></i>&nbsp;Accept</button>
                                    {{-- <button class="btn btn-danger btn-sm" onclick="acceptSettings(this,'{{$setting['id']}}', false)"><i class="fas fa-times"></i>&nbsp;Reject</button> --}}
